...
vim.keymap.set("n", "<leader>vpp", "<cmd>e ~/dotfiles/nvim/.config/nvim/lua/bunnie/lazy.lua<CR>")
vim.keymap.set("n", "<leader>i3", "<cmd>e ~/dotfiles/hyprland/.config/hypr/hyprland.conf<CR>")
